...
<body>
	...
	<script>
		function set(x){
			...
			//document.getElementById("cid").innerHTML = centerId;
		}
	</script>
			...
			<div class="col-sm-12 card ">
				...
				<div>
					...
					<form action="/centers" method="post" modelAttribute="district">
						<a class="btn btn-primary active">Age 18+</a> <input type="text"
							name="districtId" value="${dist }" style="display: none;" /> <input
							type="number" name="age" value="45" style="display: none;" /> <input
							class="form-control" type="hidden" name="mcenterId"
							value="district" id="modalCenterId" readonly="readonly" /> <input
							class="form-control" name="mail" placeholder="Enter you email"
							type="hidden" /> <input class="form-control" type="hidden"
							name="flag" value="0" /> <input type="submit" value="Age 45+"
							class="btn btn-light" />
					</form>
						...
						<div class="modal-content">
							...
							<form action="/centers" method="post" modelAttribute="district">
								<div class="modal-body">
									...
									<input class="form-control" type="hidden" name="age" value="18" />
