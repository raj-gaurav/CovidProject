		...
		<div class="row">
			<div class="col-sm-12 card col-lg-8 pt-2">
				...
				<form action="/centers" method="post" modelAttribute="district">
					<div class="h6 alert-primary"
						style="padding: 15px; border-radius: 20px;">Select Your
						District</div>
					<input type="number" value="18" style="display: none;" name="age" />
					<select name="districtId"
						style="padding: 15px; border-radius: 20px; width: 100%">
					...
					<input class="form-control" type="hidden"
						name="mcenterId" id="modalCenterId" value="district" readonly="readonly" /> <input
						...
						<input type="submit"
						value="Next" class="mt-2 btn btn-primary" />
				</form>
